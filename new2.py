...
class TaskSched:
    ...
    def __init__(self):
        #self.sched = BackgroundScheduler(daemonic=False)
...
#        self._pool = Pool(4)
   ...
   #     return  job_cmd
    ...
    def block_sched(self,cmd,trigger,sec):
        self.sched.add_job(lambda :cmd,'interval',seconds=1)
        self.sched.start()

    #def task(self):
    #    cmd = "echo 'test' >> /Users/Corazon/PycharmProjects/untitled7/sch.log"
